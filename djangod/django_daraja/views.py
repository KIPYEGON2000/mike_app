...
def bund(request):
    if request.method == 'POST':
        ...
        if INPUT is not None:
            lastInput1=INPUT.split("*")

            
            lastInput = lastInput1[-1]  # Get the last element of inputArray
            ...
            if lastInput == '34#':
                ...
                print(inputArray)
            elif len(inputArray)==1 and lastInput=='1#':
                response = f"CON Check {inputArray} Credit Score\n1. Credit Score\n2. Crb Check"
                inputArray.append(INPUT)
                print(inputArray)
            elif len(inputArray) == 2  and lastInput=='2#':
                inputArray.append(INPUT)
                print(inputArray)
            elif len(inputArray) == 3  and lastInput=='3#':
                response =  "CON Please Enter Your Email"
                inputArray.append(INPUT)
                print(inputArray)
            elif len(inputArray) == 4  and lastInput=='4#':
                response =  "END Please Proceed To pay And your score will be emailed to you."
            elif lastInput ==5  and lastInput=='5#':
